    ...
    <div className="max-w-4xl space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <h1 className="text-xl font-semibold">
          Imágenes — <span className="font-normal">{product.name}</span>
        </h1>
      ...
      <p className="text-xs text-neutral-600">
        Subí imágenes generales del producto o asociadas a una variante. La imagen marcada
        como <span className="font-medium">Principal</span> se muestra primero en el catálogo.
        El texto alternativo (ALT) ayuda a la accesibilidad y a que el sistema identifique
        mejor la variante en la página de producto (por ejemplo:
